...
<div class="page-container container-fn">
    ...
    <?php
    // The map endpoint from fortnite-api.com
    ...
    <div class="feature-card" style="padding: 20px; max-width: 1000px; margin: 0 auto;">
        <div style="position: relative; text-align: center;">
            <img id="map-image" 
                 ...
                 onerror="this.onerror=null; this.src='https://fortnite-api.com/images/map.png';">
        </div>
    ...
    <div style="margin-top: 50px; max-width: 1000px; margin-left: auto; margin-right: auto;">
        ...
        <div class="items-grid" style="grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 15px;">
            ...
            <div class="feature-card" style="padding: 15px; text-align: center;">
                <span style="font-size: 1.8rem;"><?php echo $poi['icon']; ?></span>
                <p style="margin-top: 10px; font-weight: 600;"><?php echo htmlspecialchars($poi['name']); ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
function showMap(type) {
    ...
    if(type === 'poi') {
        mapImg.src = 'https://media.fortniteapi.io/images/map.png?showPOI=true';
        btnPoi.classList.remove('btn-fn-outline');
        btnBlank.classList.add('btn-fn-outline');
    } else {
        mapImg.src = 'https://media.fortniteapi.io/images/map.png';
